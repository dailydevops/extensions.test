...
[![NuGet](https://img.shields.io/nuget/v/NetEvolve.Extensions.XUnit.svg)](https://www.nuget.org/packages/NetEvolve.Extensions.XUnit/)

**NetEvolve.Extensions.XUnit** is a .NET library that provides consistent test categorization attributes for XUnit, enabling seamless integration with multi-framework test solutions. This library allows teams to apply standardized test categories across different testing frameworks, making test filtering and execution management uniform and predictable.
...
```xml
<PackageReference Include="NetEvolve.Extensions.XUnit" Version="1.0.0" />
```
...
Use the attributes with XUnit's filtering capabilities:
...
- [NetEvolve.Extensions.XUnit](https://www.nuget.org/packages/NetEvolve.Extensions.XUnit) (this package)
